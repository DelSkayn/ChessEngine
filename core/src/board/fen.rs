...
pub enum FenError{
    ...
    TooManyRows,
    #[error("did not define all squares in a row")]
    MissingSquares,
    #[error("found multiple of the same color king")]
    MultipleKings,
    ...
    InvalidOrderCastling,
    #[error("invalid halftime count")]
    InvalidHalftime,
    #[error("invalid moves count")]
    InvalidMovetime,
