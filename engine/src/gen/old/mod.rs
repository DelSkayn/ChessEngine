...
use crate::util::{BoardArray, DirectionArray};
mod fill_7;
...
pub trait Player {
    ...
    const KING_CASTLE_STATE: u8;
    const KING_CASTLE_TARGET: BB;
    const QUEEN_CASTLE_STATE: u8;
...
impl Player for White {
    ...
    const KING_CASTLE_STATE: u8 = ExtraState::WHITE_KING_CASTLE;
    const KING_CASTLE_TARGET: BB = BB(6);
    const QUEEN_CASTLE_STATE: u8 = ExtraState::WHITE_QUEEN_CASTLE;
...
impl Player for Black {
    ...
    const KING_CASTLE_STATE: u8 = ExtraState::BLACK_KING_CASTLE;
    const QUEEN_CASTLE_STATE: u8 = ExtraState::BLACK_QUEEN_CASTLE;
...
impl MoveGenerator {
    ...
    pub fn gen_moves_player<P: Player>(&self, b: &Board, res: &mut Vec<Move>) {
        ...
        if b.state.castle & P::KING_CASTLE_STATE != 0 {
        ...
        if b.state.castle & P::QUEEN_CASTLE_STATE != 0 {
