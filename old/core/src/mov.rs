...
/// A piece to which can be promoted. Color independent.
#[repr(u16)]
...
impl Move {
    ...
    pub const FROM_MASK: u16 = 0b11_1111;
    pub const TO_MASK: u16 = 0b11_1111 << 6;

    pub const TYPE_MASK: u16 = 0b11 << 12;
    pub const TYPE_NORMAL: u16 = MoveKind::Normal as u16;
    pub const TYPE_CASTLE: u16 = MoveKind::Castle as u16;
    pub const TYPE_PROMOTION: u16 = MoveKind::Promotion as u16;
    pub const TYPE_EN_PASSANT: u16 = MoveKind::EnPassant as u16;

    pub const PROMOTION_MASK: u16 = 0b11 << 14;
    pub const PROMOTION_QUEEN: u16 = Promotion::Queen as u16;
    pub const PROMOTION_KNIGHT: u16 = Promotion::Knight as u16;
    pub const PROMOTION_ROOK: u16 = Promotion::Rook as u16;
    pub const PROMOTION_BISHOP: u16 = Promotion::Bishop as u16;
